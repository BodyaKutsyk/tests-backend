...
export class GenerateDb1790278101632 implements MigrationInterface {
    name = 'GenerateDb1790278101632'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "generation_jobs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "question_type" "public"."generation_jobs_question_type_enum" NOT NULL, "status" "public"."generation_jobs_status_enum" NOT NULL DEFAULT 'queued', "question_count" integer NOT NULL, "test_id" uuid, "user_id" uuid, CONSTRAINT "REL_c7f60f9fddb0ab38af5ca4f082" UNIQUE ("test_id"), CONSTRAINT "PK_6b6b705e0fed45c8440c1d7d637" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "storage_key" character varying(512) NOT NULL, "name" character varying(254) NOT NULL, "mime_type" character varying(100) NOT NULL, "size" bigint NOT NULL, "user_id" uuid, CONSTRAINT "PK_ac51aa5181ee2036f5ca482857c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "quotas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "quota_type" "public"."quotas_quota_type_enum" NOT NULL, "max_limit" integer NOT NULL, "used" integer NOT NULL DEFAULT '0', "user_id" uuid, CONSTRAINT "PK_5f54877798333ca833245a100d1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "questions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "question_type" "public"."questions_question_type_enum" NOT NULL, "value" text NOT NULL, "test_id" uuid, CONSTRAINT "PK_08a6d4b0f49ff300bf3a0ca60ac" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "answer_options" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "value" text NOT NULL, "is_correct" boolean NOT NULL DEFAULT false, "question_id" uuid, CONSTRAINT "PK_6f7aad84d76ce387af24c1231cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."evaluation_jobs_status_enum" AS ENUM('queued', 'evaluating', 'done', 'failed')`);
        await queryRunner.query(`CREATE TABLE "evaluation_jobs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."evaluation_jobs_status_enum" NOT NULL DEFAULT 'queued', "attempt_id" uuid, CONSTRAINT "REL_ed5eedc480674f5054a942b2ad" UNIQUE ("attempt_id"), CONSTRAINT "PK_25d723fd13ed62b277c1166f106" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "evaluations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "explanation" text, "is_correct" boolean NOT NULL DEFAULT false, "evaluation_job_id" uuid, "response_id" uuid, CONSTRAINT "REL_99e4357de2df3222e21f932d03" UNIQUE ("response_id"), CONSTRAINT "PK_f683b433eba0e6dae7e19b29e29" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "responses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "value" text, "question_id" uuid, "answer_option_id" uuid, "attempt_id" uuid, CONSTRAINT "PK_be3bdac59bd243dff421ad7bf70" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "attempts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "score" smallint NOT NULL DEFAULT '0', "user_id" uuid, "test_id" uuid, CONSTRAINT "PK_295ca261e361fd2fd217754dcac" PRIMARY KEY ("id"))`);
